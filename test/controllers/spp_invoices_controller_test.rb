...
class SppInvoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spp_invoice" do
    assert_difference("SppInvoice.count") do
      post spp_invoices_url, params: { spp_invoice: { amount: @spp_invoice.amount, category_id: @spp_invoice.category_id, paid_amount: @spp_invoice.paid_amount, status: @spp_invoice.status, student_id: @spp_invoice.student_id } }
    end
  ...
  test "should update spp_invoice" do
    patch spp_invoice_url(@spp_invoice), params: { spp_invoice: { amount: @spp_invoice.amount, category_id: @spp_invoice.category_id, paid_amount: @spp_invoice.paid_amount, status: @spp_invoice.status, student_id: @spp_invoice.student_id } }
